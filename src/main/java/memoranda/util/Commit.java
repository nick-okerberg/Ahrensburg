...
public class Commit implements Comparable {
    ...
    private int _numTests; // US37, number of tests in a commit from parsing
                           // commit message. Nick Okerberg.
    private Date _date;
     ...
     *            sha of commit
     * @param authorName
     *            Full name of author of commit
     * @param dateString
     *            The date of the commit as a string
     * @param message
     *            The message associated with the commit
     * @param htmlUrl
     *            The String representation of the HTML version of the URL
     * @param authorLogin
     *            The GitHub login name of the author
     */
    public Commit(String sha, String authorName, String dateString,
            String message, String htmlUrl, String authorLogin, int add,
            int del, int totalLoc) {
        this.setSha(sha);
     ...
     * 
     * @param json
     *            JSON object in the form of a GitHub API Commit
     */
    public Commit(JSONObject json) throws JSONException {
        this._sha = json.getString("sha");
        this._authorName = json.getJSONObject("commit").getJSONObject("author")
                .getString("name");
    ...
    public Commit(Element root) {
        ...
        this.setDateString(root.getAttributeValue("date"));
    ...
    public void setDateString(String dateString) {
        ...
        // Also update date
        this._date = parseDate(dateString);
    }
    ...
    public void setNumTests(int tests) {
        this._numTests = tests;
    }
    ...
    public Element toXml() {
        ...
        root.addAttribute(new Attribute("authorName", _authorName));
        root.addAttribute(new Attribute("date", _dateString));
     ...
     * 
     * "JUNIT-XX#" where "XX" represents the number of tests included in this
     * commit.
     * 
     * Returns an integer value representing the number of tests.
     * 
     * @param msg
     *            The input String representing the commit message.
    ...
    private int getNumTestsFromMessage(String msg) {
        ...
        /*
         * Parse the numbers out of the input string. Format: "JUNIT-XX#" This
         * will parse the XX number out of the above example. Find the first
         * " - " and end at the " # " symbol.
         */
        if (msg.contains("JUNIT-") && msg.contains("#")
                && (msg.indexOf("JUNIT-") < msg.indexOf("#"))) {

            String parsed = msg.substring(msg.indexOf("JUNIT-") + 6,
                    msg.indexOf("#"));

            // For debugging:
            // System.out.println("[DEBUG] commit message: " + msg);
            // System.out.println(" parsed: " + parsed);
            // System.out.println("[DEBUG] parsed test value to return: " +
